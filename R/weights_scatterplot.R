...
weights_scatterplot <- function(robust_estimate, save_pdf = FALSE,
  ...
  if (save_pdf){
    ...
    plot(or_weights,rob_weights, pch = 3, cex = 0.5, col = 'white', lwd = 1,
         xlab = 'Original weights', ylab = 'Robust weights')
    text(or_weights,rob_weights, labels = unit_namess[index_sub],
         cex = 0.7, font = 1)
    ...
    plot(or_weights,rob_weights, pch = 3, cex = 0.5, col = 'white', lwd = 1,
         xlab = 'Original weights', ylab = 'Robust weights')
    text(or_weights,rob_weights, labels = unit_names[index_sub],
         cex = 0.7, font = 1)
    abline(a = 0, b = 1, lty = 2, lwd = 0.5, col = 'grey')
  }
}  