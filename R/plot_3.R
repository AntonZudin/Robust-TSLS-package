...
#' @method Plot for original weights and robust weights.
#' @export
#'

plot_3 <- function(robust_estimate, width = 9, height = 9) {
  ...
  pdf('plots/nak_weights.pdf', width = width, height = height )
